...
![Pyramid to research quality data.](radiosonde_qaqc.png){fig-alt="Radiosonde Data QA/QC schematic."}

---

## [DYNAMO/CINDY/AMIE](https://www.eol.ucar.edu/field_projects/dynamo)
...
![The DYNAMO/CINDY/AMIE upper-air sounding network (Johnson & Ciesielski 2013).](dynamo_sounding_network.png){fig-alt="The DYNAMO/CINDY/AMIE upper-air sounding network."}
...
::: {layout-ncol=2}
![Storm Tracker mini-radiosonde.](storm_tracker.jpeg){fig-alt="Storm Tracker mini-radiosonde"}

![Co-launch configuration with a Vaisala RS41-SGP.](co_launch.jpeg){fig-alt="Storm Tracker attached to an RS41 for co-launch"}
:::
...
![TASSE upper-air sounding network.](tasse_field_campaign.png){fig-alt="TASSE upper-air sounding network."}
